...
#---------------------------------------------------------------------------------------------------------------------------------------------
#authentication
gs4_auth(email = "my_email@email.com", path = "my_service_account")

#----------------------------------------------------------------------------------------------------------------------------------------------
#save the google sheet data 
our_sheet <- gs4_get("my_google_sheet")
...
server <- function(input, output, session) {
    ...
    output$message_to_user <- renderText("Thank you for volunteering to help with my thesis! Please listen to the recordings below and email my_email@email.com with any questions \nRate the following recordings on a scale of 1 (worst) to 10 (best)")
