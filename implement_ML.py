...
def evaluate_recording(path_to_file, ridge_reg):
...
def main():
    training_data = pd.read_csv("C:\\Users\\baile\\OneDrive\\Desktop\\Classes\\Fall2020Classes\\Thesis\\Please_Dont_Sing\\audio_differences.csv")    
    ridge_reg = train_model(training_data)
    #get the list of frequencies from the file 
   
    pred = evaluate_recording("C:\\Users\\baile\\OneDrive\\Desktop\\Classes\\Fall2020Classes\\Thesis\\A.mp3", ridge_reg)    
    print(pred)    
